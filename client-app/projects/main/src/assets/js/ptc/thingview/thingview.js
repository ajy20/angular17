...
var ThingView = (function () {
    ...
    var s_fileversion = "0.45.5.0";
    var s_productversion = "0.45.5+M5KI0L";
    var s_productname = "ThingView 0.45";
    var doCapture = false;
    var captureWrapper;
    var requestID = null;
        ...
        LoadDocument: function(viewable, parentCanvasId, model, isWindowless, callback) {
            if (thingView2dScript == "") {
                ...
                thingView2dScript.onload = function(){
                    ThingView.LoadDocument(viewable, parentCanvasId, model, isWindowless, callback);
                };
                document.getElementsByTagName('head').item(0).appendChild(thingView2dScript);
            }
        },
        LoadPdfAnnotationSet: function(viewable, parentCanvasId, docScene, structure, annoSet, isWindowless, callback) {
            if (thingView2dScript == "") {
                thingView2dScript = document.createElement("script");
                thingView2dScript.src = ThingView.resourcePath ? ThingView.resourcePath + "/thingview2d.js" : "thingview2d.js";
                thingView2dScript.onload = function(){
                    ThingView.LoadPdfAnnotationSet(viewable, parentCanvasId, docScene, structure, annoSet, isWindowless, callback);
                };
                document.getElementsByTagName('head').item(0).appendChild(thingView2dScript);
            }
        },
        LoadPDF: function(parentCanvasId, data, isUrl, isWindowless, callback) {
            if (thingView2dScript == "") {
                thingView2dScript = document.createElement("script");
                thingView2dScript.src = ThingView.resourcePath ? ThingView.resourcePath + "/thingview2d.js" : "thingview2d.js";
                thingView2dScript.onload = function(){
                    ThingView.LoadPDF(parentCanvasId, data, isUrl, isWindowless, callback);
                };
                document.getElementsByTagName('head').item(0).appendChild(thingView2dScript);
            }
        },
